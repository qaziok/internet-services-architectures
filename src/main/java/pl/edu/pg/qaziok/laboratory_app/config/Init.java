...
public class Init {
    ...
    public synchronized void init(){
        ...
        // Steven Spielberg
        movies.put(Director.builder().name("Steven Spielberg").birthDate(LocalDate.of(1946, 12, 18)).build(), List.of(
        ...
        // Stanley Kubrick
        movies.put(Director.builder().name("Stanley Kubrick").birthDate(LocalDate.of(1928,7,26)).build(), List.of(
        ...
        // Martin Scorsese
        movies.put(Director.builder().name("Martin Scorsese").birthDate(LocalDate.of(1942,11,17)).build(), List.of(
        ...
        // Christopher Nolan
        movies.put(Director.builder().name("Christopher Nolan").birthDate(LocalDate.of(1970,7,30)).build(), List.of(
        ...
        // Quentin Tarantino
        movies.put(Director.builder().name("Quentin Tarantino").birthDate(LocalDate.of(1963,3,27)).build(), List.of(
        ...
        // Alfred Hitchcock
        movies.put(Director.builder().name("Alfred Hitchcock").birthDate(LocalDate.of(1899,8,13)).build(), List.of(
        ...
        // James Cameron
        movies.put(Director.builder().name("James Cameron").birthDate(LocalDate.of(1954,8,16)).build(), List.of(
        ...
        // George Lucas
        movies.put(Director.builder().name("George Lucas").birthDate(LocalDate.of(1944,5,14)).build(), List.of(
        ...
        // David Fincher
        movies.put(Director.builder().name("David Fincher").birthDate(LocalDate.of(1962,8,28)).build(), List.of(
        ...
        // Tim Burton
        movies.put(Director.builder().name("Tim Burton").birthDate(LocalDate.of(1958,8,25)).build(), List.of(
        ...
        // Edgar Wright
        movies.put(Director.builder().name("Edgar Wright").birthDate(LocalDate.of(1974,4,18)).build(), List.of(
